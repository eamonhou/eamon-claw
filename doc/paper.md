...
3.1.1 宿主机多维硬件负载标量契约
3.1.2 慢查询日志语义实体契约
3.1.3 隔离分析库多模态快照返回类契约
3.2 LA-CPM 代价演算层机制设计
3.3 智能体层高阶认知与控制流设计
3.4 本章小结
...
4.2 智能体层异步控制与认知演进实现
4.2.1 基于 ReAct 范式的 Main Loop 思考流程
4.2.2 基于阶梯降级的 Context Compaction 策略
4.2.3 基于文件系统的持久化记忆与待办管理
4.3 本章小结
